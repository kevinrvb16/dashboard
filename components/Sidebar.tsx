...
const Sidebar = () => {
  return (
    <div className="flex w-full flex-col bg-mutted/40">
        ...
        >
            ...
            <nav className="mt-auto flex flex-col items-center gap-4 pw2 py-5">
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                ...
                <Sheet>
                    ...
                    <SheetContent side="left" className="sm:max-w-x">
                        <nav className="grid gap-6 text-lg font-medium">
                            <Link href="#"
                                className=" flex h-10 w-10 bg-primary rounded-fill text-lg
